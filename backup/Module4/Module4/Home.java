...
public class Home {
    ...
    public Boolean isNoResultFound() {
        ...
        try {
            ...
            status = driver
                    .findElementByXPath("//*[contains(text(),' No products found ')]")
                    .isDisplayed();
            return status;
        } catch (Exception e) {
            return status;
    ...
    public Boolean verifyCartContents(List<String> expectedCartContents) {
        try {
            ...
            WebElement cartParent = driver.findElement(By.xpath("//*[contains(@class,'cart')]"));
            ...
            for (WebElement cartItem : cartContents) {
                actualCartContents.add(
                        cartItem.findElement(By.xpath(".//following-sibling::div[contains(@class,'css-1gjj37g')]")).getText().split("\n")[0]);
            }
